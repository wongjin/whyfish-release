 ...
 *
 * 职责：存放 6 个内置的分析示例数据，以避免 file:// 协议下的跨域 fetch 限制，支持纯离线环境。
 *
 * v5.0 变更：
...
(function (win) {
  ...
  win.EXAMPLES_DATA = {
    ...
    // =========================================================
    // #6 — FTA: 五分类血液分析仪 WBC 计数假性升高（医学检验）
    // =========================================================
    'fta-wbc-count': {
      _format: 'tool-problem-analysis/v1',
